...
eng_mpn = '5273-{n:02d}A'
new_mpn_example = '09-65-2{n:02d}8'
...
def generate_one_footprint(pincount, configuration):
    ...
    body_edge={
        'left':start_pos_x - pin_inside_distance,
        'right':end_pos_x + pin_inside_distance,
        'top':-5.6
        }
    body_edge['bottom'] = body_edge['top']+10.75
    ...
    # create silkscreen with a notch near pin 1
    notche_x = nudge + pin_inside_distance + pin_w/2
    ...
    kicad_mod.append(PolygoneLine(polygone=[
        ...
        [body_edge['left'] - nudge + notche_x, body_edge['top'] - nudge - notche_p],\
        [body_edge['left'] - nudge + notche_x+notche_l, body_edge['top'] - nudge - notche_p],\
        [body_edge['left'] - nudge + notche_x+notche_l, body_edge['top'] - nudge],\
        ...
        [body_edge['left'] - nudge, body_edge['bottom'] + nudge - offset_ramp_y],\
        [body_edge['right'] + nudge, body_edge['bottom'] + nudge - offset_ramp_y]], layer='F.SilkS',
        width=silk_w))
